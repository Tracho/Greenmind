...
function Catalog({ dataProducts, datacurrency, HOST_STRIPE, LoadingCatalog }
  ...
  return (<>
    {/* <div className="flex w-full flex-wrap justify-start relative gap-2.5"> */}
<div className="grid grid-cols-1 min-[400px]:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 w-full gap-2.5 relative">
